...
### 2.3.1 Altura y Peso para todos los Pokémon
...
- En algunos casos, la masa de los Pokémon puede superar los 750 kg, mientras que la altura máxima se encuentra por debajo de los 15 m.
...
### 2.3.2 Altura y Peso según el tipo de Pokémon
...
- Hay tipos donde la pendiente es cero, como en Oscuro y Tierra, lo cual indica que, para esos tipos, la altura es prácticamente independiente del peso. Esto puede sugerir que hay poca variación en la altura para los Pokémon de esos tipos, sin importar cuánto pesen.
...
### 2.5 Relación entre HP y Defensa / Defensa Especial
