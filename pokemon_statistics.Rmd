...
Como dato adicional , calcularemos los coeficientes de determinación (R-square) , la cual es una herramienta que nos ayuda a entender como un modelo de regresión se adapta a los datos:
