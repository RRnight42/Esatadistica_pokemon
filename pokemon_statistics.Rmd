...
La función en combate de un pokemon viene determinada por sus estadísticas y el reparto de las mismas. Y a su vez estas estadísticas vienen determinadas por varios factores, como la etapa evolutiva, la rareza del pokemon (normal, legendario, singular, etc), o los posibles tipos del pokemon.
