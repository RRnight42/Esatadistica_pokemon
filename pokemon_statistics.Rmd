...
```
La desviación estándar es de 28.32747. Esto indica que la variabilidad de los valores de HP entre los diferentes Pokémon monotipos es moderada, existe dispersión, pero no es extremadamente alta ni extremadamente baja. En otras palabras, hay cierta diversidad en los puntos de vida de los Pokémon monotipos, pero no es demasiado pronunciada
...
En este gráfico de caja, se pueden observar las diferencias en los valores de Ataque entre los distintos tipos de Pokémon. La dispersión es notable, sugiriendo que algunos tipos tienen un mayor potencial ofensivo que otros.
...
La media del ataque para los Pokémon monotipos es de 73.66934. Esto representa el valor promedio de ataque que tienen los Pokémon con un solo tipo elemental.

```{r}
cat("Desviación estándar de Ataque:", sd_attack, "\n")
```

La desviación estándar es de 29.18733. Esto sugiere que hay una variabilidad considerable en el ataque de los Pokémon según su tipo. Es decir, algunos Pokémon tienen ataques muy por encima o por debajo del promedio, lo que refleja una diversidad en las capacidades ofensivas dependiendo de ello.
...
Los Pokémon con menores valores en su ataque son Chansey y Happiny, ambos de tipo normal y el Pokémon con mayor ataque es Rampardos de tipo roca, siendo este uno de los tipos de Pokémon con un ataque promedio más alto. Esto permite identificar qué tipos de Pokémon tienen mejor desempeño en el combate ofensivo.
...
El gráfico de caja presenta la distribución de la defensa en relación a los tipos de Pokémon. La variabilidad de la defensa entre los diferentes tipos puede proporcionar información valiosa sobre su resistencia en combate.
...
```
La media de la defensa para los Pokémon monotipos es de r mean_defense. Esto refleja el valor promedio de defensa que tienen los Pokémon con un solo tipo elemental.
...
La desviación estándar es de r sd_defense. Esto indica que, en promedio, los valores de defensa se desvían de la media en aproximadamente X puntos (sustituir X por el valor calculado), lo que sugiere que hay diversidad en la defensa entre los Pokémon monotipos.
...
Los Pokémon con menores valores en su defensa son r min_defense_pokemon$name de tipo r min_defense_pokemon$type1, mientras que el Pokémon con mayor defensa es r max_defense_pokemon$name de tipo r max_defense_pokemon$type1. Esto destaca qué tipos de Pokémon son más efectivos en resistir ataques.

<br>

#### 2.4.4 Ataque especial

A continuación se analizará la relación entre el ataque especial (sp_atk) y los tipos elementales Pokémon:
...
El gráfico de caja muestra la distribución del ataque especial entre los distintos tipos de Pokémon. La variabilidad en el ataque especial puede influir en el desempeño general en combate de los Pokémon que dependen de movimientos especiales.
...
La media del ataque especial para los Pokémon monotipos es de r mean_sp_atk. Esto representa el valor promedio de ataque especial que tienen los Pokémon con un solo tipo elemental.
...
La desviación estándar es de r sd_sp_atk. Esto indica que, en promedio, los valores de ataque especial se desvían de la media en aproximadamente X puntos (sustituir X por el valor calculado). Esta variabilidad sugiere que algunos Pokémon tienen capacidades especiales que pueden influir significativamente en el resultado de los combates.
...
```
Los Pokémon con menores valores en su ataque especial son r min_sp_atk_pokemon$name de tipo r min_sp_atk_pokemon$type1, y el Pokémon con mayor ataque especial es r max_sp_atk_pokemon$name de tipo r max_sp_atk_pokemon$type1. Esto permite resaltar qué tipos de Pokémon son más eficaces utilizando movimientos especiales.
