...
# Gráfico de barras para estdicticas totales
ggplot(pokemon_table, aes(y = total)) +
  geom_bar(fill = "gray", color = "black") +
  labs(title = "Distribución de estadíscticas totales", x = "Frecuencia", y = "Estadísticas totales") +
  theme_minimal()
...
## 5.2 Estadisticas individuales de Pokémon



### 5.2.1 HP (Puntos de salud)
...
## 6.1 Estadisticas totales vs tipos de pokemon
...
## 6.2 Comparativas entre estadísticas en base a la Velocidad
...
### 6.2.1 La Velocidad en base al Ataque
...
### 6.2.2 La Velocidad en base a la Defensa
...
## 6.4 Comparación entre Tipo Elemental y las estadísticas de combate del Pokémon
