...
Se puede observar que hay una tendencia positiva gracias a la línea roja, lo cual sugiere que sí que existe cierta relación entre HP y Defensa. Sin embargo no se puede afirmar que esto sea así en la mayoría de los casos ya que los puntos están poco concentrados, por lo que la relación anteriormente mencionada  no es muy fuerte.
