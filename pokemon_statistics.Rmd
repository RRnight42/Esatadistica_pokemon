...
La suma de estadísticas nos aporta información crucial sobre cuán bueno es el Pokémon a nivel competitivo. Para ello, hemos recogido los datos de todos los Pokémon y los hemos puesto en un gráfico de barras:
...
#### **Mediana**
La **mediana** de los pesos indica el valor central de la distribución, enseñando el punto en el que unos Pokémon tienen mayor suma o menor suma.
