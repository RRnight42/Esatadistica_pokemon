...
Como podemos observar a lo largo del aumento de los puntos de estadísticas hay cuatro puntos de interés donde se concentran una mayor cantidad de Pokémon con tantos puntos de combate:

Por una parte, podemos ver tres picos de concentración en los puntos 200, 300 y 500. Estos puntos destacan sobre los demás ya que como sabemos la mayor parte de los Pokémon tienen tres etapas evolutivas y cada uno de estos picos se centra en una de estas etapas, la primera etapa corresponde al pico de 200 puntos, la segunda al pico de 300 y la tercera al pico de 500, ya que un Pokémon a medida que evoluciona se hace más fuerte progresivamente

Por otra parte, podemos ver que hay un pequeño grupo de Pokémon que tienen una suma total de puntos mayor a 600. Este grupo corresponde al grupo de los Pokémon legendarios, ya que estos poseen un gran poder.
